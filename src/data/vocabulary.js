...
export const vocabulary = [
  ...
  // ── Диалоги / Ежедневные слова ─────────────────────────
  { id: 401, word: '비빔밥', pronunciation: 'bibimbap', ko: '밥 위에 야채와 고추장', en: 'bibimbap', ru: 'пибимпаб (рис с овощами)', category: 'food' },
  { id: 402, word: '불고기', pronunciation: 'bulgogi', ko: '양념한 고기 요리', en: 'bulgogi', ru: 'пульгоги (мясо на гриле)', category: 'food' },
  { id: 403, word: '아메리카노', pronunciation: 'amerikano', ko: '에스프레소에 물을 탄 커피', en: 'americano', ru: 'американо', category: 'food' },
  { id: 404, word: '콜라', pronunciation: 'kolla', ko: '탄산 음료', en: 'cola', ru: 'кола', category: 'food' },
  { id: 405, word: '반찬', pronunciation: 'banchan', ko: '밥과 함께 먹는 작은 요리', en: 'side dishes', ru: 'панчан (закуски)', category: 'food' },
  { id: 406, word: '봉투', pronunciation: 'bongtu', ko: '물건을 담는 주머니', en: 'bag / plastic bag', ru: 'пакет', category: 'daily' },
  { id: 407, word: '영수증', pronunciation: 'yeongsujeung', ko: '구매 증명서', en: 'receipt', ru: 'чек', category: 'daily' },
  { id: 408, word: '환불', pronunciation: 'hwanbul', ko: '돈을 돌려 받음', en: 'refund', ru: 'возврат денег', category: 'daily' },
  { id: 409, word: '구급차', pronunciation: 'gugeupcha', ko: '응급 환자를 옮기는 차', en: 'ambulance', ru: 'скорая помощь', category: 'daily' },
  { id: 410, word: '경찰', pronunciation: 'gyeongchal', ko: '치안을 담당하는 사람', en: 'police', ru: 'полиция', category: 'daily' },
  { id: 411, word: '지하철', pronunciation: 'jihacheol', ko: '땅 밑으로 다니는 열차', en: 'subway', ru: 'метро', category: 'daily' },
  { id: 412, word: '택시', pronunciation: 'taeksi', ko: '유료 승용차', en: 'taxi', ru: 'такси', category: 'daily' },
  { id: 413, word: '공항', pronunciation: 'gonghang', ko: '비행기를 타는 곳', en: 'airport', ru: 'аэропорт', category: 'travel' },
  { id: 414, word: '호텔', pronunciation: 'hotel', ko: '숙박 시설', en: 'hotel', ru: 'отель', category: 'travel' },
  { id: 415, word: '약국', pronunciation: 'yakguk', ko: '약을 파는 곳', en: 'pharmacy', ru: 'аптека', category: 'daily' },
  { id: 416, word: '은행', pronunciation: 'eunhaeng', ko: '돈을 맡기거나 빌리는 곳', en: 'bank', ru: 'банк', category: 'daily' },
  { id: 417, word: '편의점', pronunciation: 'pyeonuijeom', ko: '작은 상점 (24시간)', en: 'convenience store', ru: 'мини-маркет', category: 'daily' },
  { id: 418, word: '식당', pronunciation: 'sikdang', ko: '밥을 먹는 곳', en: 'restaurant', ru: 'ресторан', category: 'daily' },
  { id: 419, word: '메뉴판', pronunciation: 'menyupan', ko: '음식 목록표', en: 'menu', ru: 'меню', category: 'food' },
  { id: 420, word: '계산', pronunciation: 'gyesan', ko: '돈을 내는 것', en: 'payment / bill', ru: 'оплата / счёт', category: 'daily' },
  { id: 421, word: '항공권', pronunciation: 'hanggonggwon', ko: '비행기표', en: 'airplane ticket', ru: 'авиабилет', category: 'travel' },
  { id: 422, word: '창가 자리', pronunciation: 'changga jari', ko: '창문 옆 좌석', en: 'window seat', ru: 'место у окна', category: 'travel' },
  { id: 423, word: '통로 자리', pronunciation: 'tongno jari', ko: '복도 쪽 좌석', en: 'aisle seat', ru: 'место у прохода', category: 'travel' },
  { id: 424, word: '조식', pronunciation: 'josik', ko: '아침 식사', en: 'breakfast', ru: 'завтрак', category: 'food' },
  { id: 425, word: '감기약', pronunciation: 'gamgiyak', ko: '감기에 먹는 약', en: 'cold medicine', ru: 'лекарство от простуды', category: 'daily' },
  { id: 426, word: '소화제', pronunciation: 'sohwaje', ko: '소화를 돕는 약', en: 'digestive medicine', ru: 'средство для пищеварения', category: 'daily' },
  { id: 427, word: '통화', pronunciation: 'tonghwa', ko: '나라의 돈 단위', en: 'currency', ru: 'валюта', category: 'daily' },
  { id: 428, word: '달러', pronunciation: 'dalleo', ko: '미국 돈 단위', en: 'dollar', ru: 'доллар', category: 'daily' },
  { id: 429, word: '전화', pronunciation: 'jeonhwa', ko: '말을 주고받는 통신 기기', en: 'phone / phone call', ru: 'телефон / звонок', category: 'daily' },
  { id: 430, word: '점심', pronunciation: 'jeomsim', ko: '낮에 먹는 밥', en: 'lunch', ru: 'обед', category: 'food' },
  { id: 431, word: '옷', pronunciation: 'ot', ko: '몸에 입는 것', en: 'clothes', ru: 'одежда', category: 'daily' },
  { id: 432, word: '음악', pronunciation: 'eumak', ko: '소리로 만든 예술', en: 'music', ru: 'музыка', category: 'daily' },
  { id: 433, word: '한국어', pronunciation: 'hangugeo', ko: '한국의 언어', en: 'Korean language', ru: 'корейский язык', category: 'daily' },
];

export const categories = ['all', 'numbers', 'math', 'geometry', 'phrases', 'travel', 'app', 'food', 'daily'];
